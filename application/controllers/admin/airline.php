...
class Airline extends PVA_Controller
{
    ...
    {        
        ...
        $crud->columns('airline_image', 'icao', 'iata', 'name', 'total_schedules', 'total_pireps', 'total_hours', 'enabled');
        
        // Set/Unset add fields
        $crud->add_fields('airline_image', 'icao', 'iata', 'name', 'fuel_discount', 'enabled');
        
        // Set/Unset edit fields
        $crud->edit_fields('airline_image', 'icao', 'iata', 'name', 'fuel_discount', 'total_schedules', 'total_pireps', 'total_hours', 'enabled');
        ...
        $crud->set_field_upload('airline_image', config_item('img_folder_airline'));
        ...
        // Field Rules
        $crud->set_rules('icao', 'ICAO', 'required|trim|xss_clean|alpha');
        $crud->set_rules('iata', 'IATA', 'trim|xss_clean|alpha-numeric');
        ...
        // Display As
        $crud->display_as('airline_image','Logo');
        ...
        $this->data['subview'] = 'admin/airline/index';
