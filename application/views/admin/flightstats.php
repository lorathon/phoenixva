...
<div class="row">
    ...
    <div class="col-md-12">
		...
		<li class="">
		    <a href="#activate" data-toggle="tab" class="text-center" aria-expanded="false">Activate</a>
		</li>
	    </ul>
		...
		<div id="activate" class="tab-pane">
		<?php 
		    $attributes = array('class' => 'form-horizontal form-bordered');
		    echo form_open('admin/flightstats/activate');
		?>
			...
			<header class="panel-heading">
			    ...
			    <h2 class="panel-title">Activate Schedules</h2>

			    <p class="panel-subtitle">
				Move schedules (schedules_pending) to the active table (schedules).
			    </p>
			</header>					
			<div class="panel-body">			    
			    <div class="form-group">
				<label class="col-sm-3 control-label">Classification Limit</label>
				<div class="col-sm-6">
				    <select class="form-control mb-md" name="activate_number">
					<?php
					$i = 100;
					do
					{
					    echo "<option value='$i'>$i Schedules</option>";
					    $i = $i + 100;
					}
					while ($i < 1100)					
					?>
				...
				<div class="col-sm-9 col-md-offset-3">
				    <span class="help-block">Choose the number of schedules to process and activate.</span>
				</div>
			    </div>
			    <footer class="panel-footer" align="center">
