...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $view_fields_checked	= false;	//Added newly for view fields to be managed like add / edit
	...
	protected $view_fields			= null;	//Added newly for allowing user to set view fields like add / edit fields
	...
	protected $unset_view_fields	= null;	//Added newly for allowing user to unset view fields like add / edit fields
	...
	protected $callback_view_field		= array();	//Added to allow user to set the callback for each view fields
