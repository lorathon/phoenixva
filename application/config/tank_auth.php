...
|--------------------------------------------------------------------------
*/
$config['website_name']     = 'Phoenix Virtual Airways';
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = 'pvaautologin';
...
$config['recaptcha_public_key']     = '6LdT1OgSAAAAAFReOW8KvotYV8MSNTxE0aId7yt2';
$config['recaptcha_private_key']    = '6LdT1OgSAAAAAM-N0pBdLEM5uETbyQStath-FWXd';
