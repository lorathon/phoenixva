				...
				<div class="home-intro">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-8">
								<p>
									Experience the best in Flight Simulation with the leader of <em>Virtual Airlines.</em>
									<span>Get more information or join us today!</span>
								</p>
							</div>
							<div class="col-md-4">
								<div class="get-started">
									<a href="#" class="btn btn-lg btn-primary">Join PVA Now!</a>
									<div class="learn-more">or <a href="index.html">learn about us.</a></div>
								</div>
							</div>
						</div>
