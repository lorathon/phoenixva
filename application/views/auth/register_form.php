...
<table class="table">
	...
	<tr>
		<td><?php echo form_label('Birth Date', $birth_date['id']); ?></td>
		<td><?php echo form_input($birth_date); ?></td>
		<td style="color: red;"><?php echo form_error($birth_date['name']); ?><?php echo isset($errors[$birth_date['name']])?$errors[$birth_date['name']]:''; ?></td>
	</tr>
	<tr>
    ...
    <tr>
        <td colspan="3" align="center"><?php echo form_submit('register', 'Register', 'class = "btn btn-primary btn-block"'); ?></td>
    </tr>
