 ...
 * 10-31-2013
 * function: login
 * Addition of 'admin' to ci->session->userdata
 * taken from table
 * 0 = NOT admin | No admin access
 * 0-99 = Admin Level
 * BY: Jeffrey F. Kobus
*/
...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($username, $email, $password, $email_activation, $first_name, $last_name, $birth_date)
	{
